...
{
    return explode(PHP_EOL, run('grep -E -r -l -i ":author|:vendor|:package|VendorName|skeleton|migration_table_name|vendor_name|vendor_slug|author@domain.com" ./* ./.github/* | grep -v vendor | grep -v '.basename(__FILE__)));
}
